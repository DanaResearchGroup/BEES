...
class TestDispatch:
    """Reversible MM is used only when template.reversible and thermo is not irreversible.

    Production dispatch lives in ``_VectorizedRHS``; these tests check the two
    rate laws that path chooses between.
    """
